...
public class UnAuthorizedAccessToWolf extends BaseTest {
	...
	@Test
	public void AccessFIS() throws InterruptedException, IOException {
		Thread.sleep(3000);
...
//		if (driver.getCurrentUrl().equals(prop.get("FISLoginPageURL"))) {
			...
			if (PCS_errorMsg.equals(Constants.UnAuthorizedErrorMessage)) {
				System.out.println("FIS user is unauthorized to login CPS Website and shows appropriate error message");
