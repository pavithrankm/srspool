...
import Pages.StoreLocatorsPage_QPS;
import Utils.Constants;

public class StoreLocatorsPageTest_QPS extends BaseTest {


	StoreLocatorsPage_QPS slp;
...
@Test(priority=1)
	...
	hp.Locations_click();
	slp = new StoreLocatorsPage_QPS(driver);
	Thread.sleep(8000);
