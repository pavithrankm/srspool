...
public class HomePage_Global extends BasePage {
	...
	WebElement FirstLayerCategory;
	@FindBy(xpath = "//a[@id='ui-id-8']")
	WebElement SecondLayerCategory;
	@FindBy(xpath = "/html/body/div[1]/main/div[3]/div/section/div/div[1]/div/a")
	WebElement FirstCategory;
	@FindBy(xpath = "//a[text()='Locations']")
	WebElement Locations;
	@FindBy(xpath = "/html/body/div[1]/main/div[3]/div/section/div/div[1]/div[1]/a/div[2]/span")
	WebElement SecondCategory;
	@FindBy(xpath = "/html/body/div[1]/main/div[3]/div/section/div/div[1]/div[1]/a/div[2]/span")
	WebElement ThirdCategory;
	@FindBy(id = "ui-id-4")
	WebElement BrandsHeader;
	@FindBy(className = "ambrands-letter letter-B")
	WebElement B_Aplhabet;
	@FindBy(xpath = "/html/body/div[2]/div[1]/header/div[2]/div/div[1]/nav/ul/li[2]/div/div/div[2]/section[1]/div/div/div[1]/a")
	WebElement Brand;
	@FindBy(xpath = "//a[@title='become-a-customer']")
	WebElement BecomeACustomer_Header;
	@FindBy(xpath = "(//a[text()='Become a Customer'])[3]")
	WebElement BecomeACustomer_Footer;
	@FindBy(xpath = "//a[text()='Sitemap']")
	WebElement SiteMapLink;
	@FindBy(xpath = "//a[text()='Terms & Conditions of Sale']")
	WebElement TermsLink;
	@FindBy(xpath = "(//a[text()='Register Now'])[1]")
	WebElement RegisterNow;
	@FindBy(xpath = "(//strong[text()='Login'])[1]")
	WebElement AddToCart;
	@FindBy(xpath = "(//span[@class='product-image-wrapper'])[1]")
	WebElement GuestMessage;
	@FindBy(id = "search")
	WebElement SearchField;

	@FindBy(xpath = "//strong[@class='product name product-item-name']")
	List<WebElement> lineItemList;

	@FindBy(xpath = "//div[@class='klevu-name']")
	List<WebElement> lineItemListauto;
	...
	@FindBy(xpath = "//div[@id='modal-content-1']//div")
	WebElement BrandSelectPopup;
	@FindBy(xpath = "(//a[@class='dckap-redirect-link'])[2]")
	WebElement BrandSelectPopupPCS;
	@FindBy(xpath = "(//a[@class='dckap-redirect-link']//img)[1]")
	WebElement BrandSelectPopupFIS;
	@FindBy(xpath = "(//a[@class='dckap-redirect-link'])[3]")
	WebElement BrandSelectPopupQPS;
	@FindBy(xpath = "(//a[@class='dckap-redirect-link'])[4]")
	WebElement BrandSelectPopupCPS;
...
//	wait.until(ExpectedConditions.visibilityOf(Locations));
	...
	public String ValidLoginMultiBrandPCS() throws Exception

	{

		String PCS_Username = prop.getProperty("ValidLoginMulti_email");
		String PCS_Password = prop.getProperty("ValidLoginMulti_Pswd");
...
//js.executeScript("arguments[0].scrollIntoView();", ReorderPad);
	...
	public String ValidLoginMultiBrand() throws InterruptedException

	{

		String Username = prop.getProperty("ValidLoginMulti_email");
		String password = prop.getProperty("ValidLoginMulti_Pswd");
	...
	public void Multibrands() {
		
		List<WebElement> findElements = driver.findElements(By.tagName("a")); 
		
			for (WebElement alllinks : findElements) {
