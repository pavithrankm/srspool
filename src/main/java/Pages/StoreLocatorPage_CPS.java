...
public class StoreLocatorPage_CPS extends BasePage {
	...
	@FindBy(xpath="/html/body/div[6]/aside[7]/div[2]/footer/button[1]/span") WebElement Confirm;
	...
	public StoreLocatorPage_CPS(WebDriver driver)
	{
		this.driver=driver;
...
Thread.sleep(1000);
	...
	//	wait.until(ExpectedConditions.visibilityOf(ChangeBranchSelection));
		...
		Select Brand= new Select(ChangeBranchSelection);
		 Brand.selectByVisibleText(prop.getProperty("Branch3"));
